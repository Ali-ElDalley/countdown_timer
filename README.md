...
- [ ] Build `CountdownProvider` (state management for the list of countdowns) — not started
...
- `CountdownItem` — data model *(done)*
- `CountdownProvider` — list state management (ChangeNotifier) — *not started*
